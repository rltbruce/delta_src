...
export class SectionComponent implements OnInit {
  ...
  {    
    ...
    if (this.NouvelItem==false) 
    {
      ...
      this.index_api.add('section',insert_data , config).subscribe((response) =>
      {
  ...
  {    
    ...
    if (this.NouvelItem==false) 
    {
      ...
      this.index_api.add('soussection',insert_data , config).subscribe((response) =>
      {
        //this.selectedItem.nom_client=client.nom_client;
        if (this.NouvelItem == false) 
        {
            ...
            if(suppression==0) 
            {
              ...
              this.selectedItem.id_section        = produit.id_section;  
