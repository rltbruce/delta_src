...
export class ProduitComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.index_api.getAll('type_produit').subscribe((response) =>
    {      
  ...
  {    
    ...
    if (this.NouvelItem==false) 
    {
      ...
      this.index_api.add('Type_produit',insert_data , config).subscribe((response) =>
      {
  ...
  {    
    ...
    if (this.NouvelItem==false) 
    {
      ...
      this.index_api.add('produit',insert_data , config).subscribe((response) =>
      {
        //this.selectedItem.nom_client=client.nom_client;
        if (this.NouvelItem == false) 
        {
            ...
            if(suppression==0) 
            {
              ...
              this.selectedItem.type_prd        = produit.type_prd;  
